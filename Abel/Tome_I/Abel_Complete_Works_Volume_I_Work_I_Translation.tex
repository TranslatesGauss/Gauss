...
\[\varphi^{\prime} x. \varphi y+\varphi x. \varphi^{\prime} y \frac{d y}{d x}=\varphi^{\prime}(x-y)\left(1-\frac{d y}{d x}\right).\]
...
\[ \frac{\frac{d \alpha}{d x}}{\frac{d \alpha}{d y}}=\frac{F^{\prime} x+F^{\prime}(\varphi x) \varphi^{\prime} x+\ldots}{F^{\prime} y+F^{\prime}(f y) f^{\prime} y+\ldots}. \] \vspace{\baselineskip}
